...
class ChangePassword extends React.Component {
  ...
  onSubmit = () => {
    ...
    const {
      enterOldPassword, enterNewPassword, invalidPassword, paswordNotMatched,
  ...
  render() {
    ...
    const {
      password: {
        oldPasswordText, savePassword, setNewPassword, setNewPasswordHere, confirm, newPassword,
      },
    } = Constants.i18n;

    return (
      <View style={styles.container}>
        <NavigationBar style={styles.navigationBarStyle} statusBar={{ style: 'default' }} />
        <View style={styles.content}>
          ...
          >
            ...
            <Text style={styles.textStyle}>{setNewPassword}</Text>
            <Text style={styles.description}>{setNewPasswordHere}</Text>
            <TextInput
              ...
              onFocus={() => {
                this.handleScrollView(findNodeHandle(this.oldPasswordRef.current));
              }}
              onBlur={() => {
                this.resetScrollView(findNodeHandle(this.oldPasswordRef.current));
              }}
            ...
            <TextInput
              ...
              onFocus={() => {
                this.handleScrollView(findNodeHandle(this.newPasswordRef.current));
              }}
              onBlur={() => {
                this.resetScrollView(findNodeHandle(this.newPasswordRef.current));
              }}
            ...
            <TextInput
              ...
              onFocus={() => {
                this.handleScrollView(findNodeHandle(this.confirmPasswordRef.current));
              }}
              onBlur={() => {
                this.resetScrollView(findNodeHandle(this.confirmPasswordRef.current));
              }}
              onSubmitEditing={this.onSubmit}
              maxLength={16}
            />

            <Button onPress={this.onSubmit} style={styles.buttonStyle} title={savePassword} />
          </ScrollView>
        </View>
      </View>
    );
